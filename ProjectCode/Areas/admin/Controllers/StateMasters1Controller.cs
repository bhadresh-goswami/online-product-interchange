...
{
    public class StateMasters1Controller : Controller
    {
        private dbOPIEntities db = new dbOPIEntities();

        // GET: admin/StateMasters1
        ...
        // GET: admin/StateMasters1/Create
        ...
        // POST: admin/StateMasters1/Create
        ...
        // POST: admin/StateMasters1/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: admin/StateMasters1/Delete/5
        ...
        // POST: admin/StateMasters1/Delete/5
